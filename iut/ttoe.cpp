...
void TTOE::on_pushButton_clicked()
{
    hide();
    trade * j;
    j =new trade(this);
...
void TTOE::on_OK_clicked()
{
    ...
    if((egerr(sourseamount)) && adr!=""){
        ...
        source_price  = 0.1347; //get from api
